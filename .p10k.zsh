# Generated by Powerlevel10k configuration wizard on 2025-05-11 at 15:34 CEST.
...
# 24h time, vertical separators, blurred heads, blurred tails, 2 lines, disconnected,
# left frame, sparse, few icons, concise, transient_prompt, instant_prompt=verbose.
